...
const OpportunityForm: React.FC<OpportunityFormProps> = ({ onCancel, onSubmit }) => {
  ...
  const [shippingDisplayValue, setShippingDisplayValue] = useState('R$ 0,00');
  const [assemblyDisplayValue, setAssemblyDisplayValue] = useState('R$ 0,00');
